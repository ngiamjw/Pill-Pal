...
import 'package:pill_pal/pages/info_page.dart';
import 'package:pill_pal/pages/monitor_email.dart';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.only(left: 20, right: 20),
                        child: Text(
                          'Track and manage medications for those you care for directly in the app',
                          style: TextStyle(fontSize: 16),
                          textAlign: TextAlign.center,
                        ),
                      ),
