...
import 'package:pill_pal/classes/user.dart' as model;
import 'package:firebase_auth/firebase_auth.dart';
import 'package:firebase_vertexai/firebase_vertexai.dart';
import 'package:flutter/material.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:image_picker/image_picker.dart';
import 'package:pill_pal/classes/global_variables.dart';
import 'package:pill_pal/components/first_box.dart';
import 'package:pill_pal/components/medicine_container.dart';
import 'package:pill_pal/components/my_display_container.dart';
import 'package:pill_pal/pages/profile.dart';
import 'package:pill_pal/pages/settings.dart';
import 'package:pill_pal/services/firebase.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  List<int> x_list = [];
  void _changeColor(int index, bool value, String email, String user_email) {
    if (email == user_email) {
      firestoreService.updateMedicationTaken(
          email: user_email, index: index, value: !value, time: DateTime.now());
    }
  }
                            ...
                            if (x == 0 && y == 0) {
                              return Column(
                                children: [
                                  ...
                                  Text("Click on profile to add medication"),
                                ],
                              );
                            }
